...
<a href="https://galiwatch.ca/blog.html#category=climate"><button type="button" class="btn btn-secondary">Keep reading <i class="fa-solid fa-arrow-up-right-from-square"></i></button></a>
...
* Pre-trained convolutional neural network via [Movidius NCS2](https://www.intel.com/content/www/us/en/developer/tools/neural-compute-stick/overview.html) for insect detection and image screening
...
<center>
<a href="https://galiwatch.ca/blog.html#category=bees"><button type="button" class="btn btn-secondary">Keep reading <i class="fa-solid fa-arrow-up-right-from-square"></i></button></a>
</center>
...
We put a camera up and have taken a picture every minute since 2021, and are looking for the arrival and departure of the migrating Rufous hummingbird. The first and last picture of a male and female Rufous each year is [posted to iNaturalist](https://www.inaturalist.org/observations?place_id=any&taxon_id=6363&user_id=prharrigan&verifiable=any)

![We've taken about a million pictures of our birdfeeder, including a very special one: it has an male and female Rufous, and a male and female Anna humming bird on the same feeder at the same time. ](images/one_of_each.png){width=300px}

<center>
<a href="https://galiwatch.ca/blog.html#category=hummingbirds"><button type="button" class="btn btn-secondary">Keep reading <i class="fa-solid fa-arrow-up-right-from-square"></i></button></a>
</center>
...
We brought these to the [Galiano Bioblitz 2023](https://biogaliano.org/), and now have over 100,000 recordings from three different areas. Analysis of this is ongoing. 
...
<center>
<a href="https://galiwatch.ca/blog.html#category=audio%20moth"><button type="button" class="btn btn-secondary">Keep reading <i class="fa-solid fa-arrow-up-right-from-square"></i></button></a>
</center>
