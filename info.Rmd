...
Galiano is a long narrow island of the Southern Gulf Island chain situated on the western edge of the Salish Sea. Located within the coastal Douglas-fir `r pop_gloss("Biogeoclimatic zone")`, it has a semi-arid ecosystem characterized by a mild climate with cool wet winters and warm dry summers, and with annual drought conditions typically from mid-June to early October. Image adapted from [Galiano Story](https://galianostory.com/FLORAFAUNA.htm).  
...
<centre>
![](static 1040px-Airborne-particulate-size-chart.svg) {width 60%}
</centre>  
